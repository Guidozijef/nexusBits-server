  ...
  apps: [
    {
      ...
      env_production: {
        ...
        // 🚨 PocketBase 配置 — PM2 启动时 .env 文件的自动加载不可靠，必须在此处显式声明
        POCKETBASE_URL: 'http://47.109.109.134:8090',
        POCKETBASE_ADMIN_EMAIL: '913497146@qq.com',
        POCKETBASE_ADMIN_PASSWORD: '913497146zjf',
      },
